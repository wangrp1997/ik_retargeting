...
class LeapPybulletIK(Node):
    def __init__(self):
        ...
        self.glove_to_leap_mapping_scale = 1.5
    ...
    def get_glove_data(self, pose):
        ...
        hand_pos = []  
        for i in range(0,10):
            hand_pos.append([poses[i].position.x * self.glove_to_leap_mapping_scale, poses[i].position.y * self.glove_to_leap_mapping_scale, poses[i].position.z * self.glove_to_leap_mapping_scale])
